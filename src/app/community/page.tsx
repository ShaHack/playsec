              ...
              {activeTab === "feedback" && (
                ...
                >
                  ...
                  <form onSubmit={handleFeedbackSubmit} className="space-y-4">
                    ...
                    {!isLoggedIn && (
                      <div className="p-3 rounded border border-[#303030] bg-[#191919] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
                        <span className="text-[#B5B5B5]">Please sign in to submit feedback.</span>
                        <button
                          type="button"
                          onClick={loginWithGoogle}
                          className="playsec-btn-primary px-3.5 py-1.5 rounded-md font-bold text-xs flex items-center gap-2 cursor-pointer transition-colors"
                        >
                    ...
                    <button
                      ...
                      className="playsec-btn-primary w-full h-10 rounded-[6px] text-xs font-bold transition-all flex items-center justify-center gap-2 select-none"
                    >
              ...
              {activeTab === "support" && (
                ...
                >
                  ...
                  <form onSubmit={handleSupportSubmit} className="space-y-4">
                    ...
                    {!isLoggedIn && (
                      <div className="p-3 rounded border border-[#303030] bg-[#191919] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
                        <span className="text-[#B5B5B5]">Please sign in to submit support request.</span>
                        <button
                          type="button"
                          onClick={loginWithGoogle}
                          className="playsec-btn-primary px-3.5 py-1.5 rounded-md font-bold text-xs flex items-center gap-2 cursor-pointer transition-colors"
