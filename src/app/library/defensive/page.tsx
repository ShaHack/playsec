        ...
        <div className="relative z-10 mx-auto max-w-[1380px] px-6 lg:px-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
            <div className="max-w-2xl">
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#3D8B72] block mb-1">
            ...
            <div className="relative w-full md:w-80 shrink-0">
              ...
              <input
                ...
                className="w-full h-9 pl-9.5 pr-8 rounded border border-[#D9E4EA] bg-white text-xs text-[#17232D] placeholder:text-[#60717D] focus:border-[#3D8B72] focus:outline-none transition-colors"
          ...
          {loading ? (
            <div className="text-center py-16">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#3D8B72] mx-auto mb-4" />
              <p className="text-xs text-[#60717D]">Querying defensive repository...</p>
            </div>
          ) : resources.length > 0 ? (
